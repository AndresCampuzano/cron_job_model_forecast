...
# 5. Forecast next 48 hours (hourly intervals)
future_temp = model_temp.make_future_dataframe(periods=48, freq='h')
future_hum = model_hum.make_future_dataframe(periods=48, freq='h')
...
# plt.title("Humidity Forecast (48h)")
# plt.grid(True)
# plt.show()
